...
Any pure setup move that isn't temporary and doesn't deal damage, such as `Swords Dance, Focus Energy, Defense Curl, Belly Drum` etc. cannot be used on bosses AFTER the Safari Zone Pivot has been made (Gym Leaders and Pokemon League).
